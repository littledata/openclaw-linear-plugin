 ...
 */
export function mapCodexEventToActivity(event: any): ActivityContent[] {
 ...
 */
export function formatCodexCommandOutput(command: unknown, output: unknown, maxChars: number): string {
